Bienvenido a la Documentación del Jueguito de Mis Bolas
=======================================================

Este proyecto simula un conjunto de bolas que interactúan en un espacio. Se inicia el proyecto con 10 bolas, con colisión. Dependiendo de su velocidad y masa, cada vez que chocan 
estas bolas desprenderán fragmentos, que también tienen masa y velocidad y pueden repetir el proceso hasta que sean muy pequeñas y desaparezcan.
...
.. toctree::
   ...
   screensaver  # Aquí se enlaza con el archivo screensaver.rst
